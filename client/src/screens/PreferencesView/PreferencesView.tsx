...
import { Text, View, Button, Image, ScrollView, SafeAreaView, StyleSheet, Dimensions, setState, ImageBackground } from 'react-native';
...
const PreferencesView: FC<PreferencesViewProps> = (props: PreferencesViewProps) => {
  ...
  return (
    ...
    <View>
      <ImageBackground imageStyle={{ resizeMode: 'cover' }} source={require('../../resources/greenBackground.png')}>
